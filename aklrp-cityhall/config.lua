...
Config.Peds = {
    ...
    {
        model = 'cs_bankman',
        coords = vec4(350.92, 6634.36, 28.75, 138), -- second location example
        ...
        target = {
            ...
            icon = 'fa-solid fa-id-card',
            label = 'Open Winz',
            boxZone = { coords = vec3(350.92, 6634.36, 28.75), length = 1.6, width = 1.6, heading = 0.0, minZ = 29.69, maxZ = 31.69 }
        }
    }
}
...
Config.Webhook = "Place Your Webhook URL Here"
